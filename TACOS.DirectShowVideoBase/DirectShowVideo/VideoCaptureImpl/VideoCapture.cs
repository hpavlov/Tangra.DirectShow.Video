	...
	internal class VideoCapture
	{
		...
		public void EnsureConnected()
		{
			if (!IsConnected)
			{
				...
				cameraState = dsCapture.IsRunning ? VideoCameraState.videoCameraRunning : VideoCameraState.videoCameraError;
			}
		}
		...
		public string StartRecordingVideoFile(string preferredFileName)
		{
			...
			cameraState = dsCapture.IsRunning ? VideoCameraState.videoCameraRecording : VideoCameraState.videoCameraError;
