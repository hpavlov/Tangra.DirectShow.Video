...
;
[Setup]
;AppID was: {d4a590c6-6563-4826-b17e-6d6730e2e427}        
AppID={{9cd6a552-b46a-4b7c-9807-669a39200171} 
...
MinVersion=6.0
DefaultDirName="{cf}\ASCOM\Video\TangraVideo"
DisableDirPage=yes
DisableProgramGroupPage=yes
OutputDir="."
OutputBaseFilename="TangraVideoSetup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Video\TangraVideo"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Video\TangraVideo"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\Tangra.DirectShow.Video.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\Tangra.DirectShow.Video.dll"""; Flags: runhidden 64bit; Check: IsWin64

; Only if driver is .NET
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\Tangra.DirectShow.Video.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\Tangra.DirectShow.Video.dll"""; Flags: runhidden 64bit; Check: IsWin64
